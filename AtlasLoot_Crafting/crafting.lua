...
AtlasLoot_Data["SmithingArmorOld1"] = {
	{ 1, "s150184", "90961", "=q4=Gauntlets of Impossible Grip", "=ds=#sr# 300"};
	{ 2, "s84386", "60162", "=q4=Dark Iron Belt", "=ds=#sr# 300"};
	{ 3, "s24399", "20039", "=q4=Dark Iron Boots", "=ds=#sr# 300"};
	{ 4, "s23637", "19164", "=q4=Dark Iron Gauntlets", "=ds=#sr# 300"};
	{ 5, "s23636", "19148", "=q4=Dark Iron Helm", "=ds=#sr# 300"};
	{ 6, "s20876", "17013", "=q4=Dark Iron Leggings", "=ds=#sr# 300"};
	{ 7, "s20873", "16988", "=q4=Fiery Chain Shoulders", "=ds=#sr# 300"};
	{ 8, "s16746", "12641", "=q4=Invulnerable Mail", "=ds=#sr# 300"};
	{ 9, "s16729", "12640", "=q4=Lionheart Helm", "=ds=#sr# 300"};
	{10, "s16741", "12639", "=q4=Stronghold Gauntlets", "=ds=#sr# 300"};
	{11, "s27829", "22385", "=q4=Titanic Leggings", "=ds=#sr# 300"};
	{12, "s20874", "17014", "=q4=Dark Iron Bracers", "=ds=#sr# 295"};
	{13, "s20872", "16989", "=q4=Fiery Chain Girdle", "=ds=#sr# 295"};
	{14, "s16745", "12618", "=q3=Enchanted Thorium Breastplate", "=ds=#sr# 300"};
	{15, "s16742", "12620", "=q3=Enchanted Thorium Helm", "=ds=#sr# 300"};
	{16, "s16744", "12619", "=q3=Enchanted Thorium Leggings", "=ds=#sr# 300"};
	{17, "s23633", "19057", "=q3=Gloves of the Dawn", "=ds=#sr# 300"};
	{18, "s23629", "19048", "=q3=Heavy Timbermaw Boots", "=ds=#sr# 300"};
	{19, "s16728", "12636", "=q3=Helm of the Great Chief", "=ds=#sr# 300"};
	{20, "s16724", "12633", "=q3=Whitesoul Helm", "=ds=#sr# 300"};
	{21, "s16731", "12613", "=q3=Runic Breastplate", "=ds=#sr# 300"};
	{22, "s16661", "12632", "=q3=Storm Gauntlets", "=ds=#sr# 295"};
	{23, "s16660", "12625", "=q3=Dawnbringer Shoulders", "=ds=#sr# 290"};
	{24, "s16655", "12631", "=q3=Fiery Plate Gauntlets", "=ds=#sr# 290"};
	{25, "s23632", "19051", "=q3=Girdle of the Dawn", "=ds=#sr# 290"};
	{26, "s23628", "19043", "=q3=Heavy Timbermaw Belt", "=ds=#sr# 290"};
	{27, "s15296", "11604", "=q3=Dark Iron Plate", "=ds=#sr# 285"};
	{28, "s16667", "12628", "=q3=Demon Forged Breastplate", "=ds=#sr# 285"};
	{29, "s16650", "12624", "=q3=Wildthorn Mail", "=ds=#sr# 270"};
	{30, "s36122", "30069", "=q3=Earthforged Leggings", "=ds=#sr# 260"};
	Next = "SmithingArmorOld2";
	Back = "SMITHINGMENU";
};

AtlasLoot_Data["SmithingArmorOld2"] = {
	{ 1, "s36124", "30070", "=q3=Windforged Leggings", "=ds=#sr# 260"};
	{ 2, "s86758", "62131", "=q3=Truesilver Belt", "=ds=#sr# 255"};
	{ 3, "s86759", "62132", "=q3=Truesilver Helm", "=ds=#sr# 250"};
	{ 4, "s84406", "60181", "=q3=Searing Grips", "=ds=#sr# 250"};
	{ 5, "s9974", "7939", "=q3=Truesilver Breastplate", "=ds=#sr# 245"};
	{ 6, "s9954", "7938", "=q3=Truesilver Gauntlets", "=ds=#sr# 225"};
	{ 7, "s9935", "7922", "=q3=Steel Plate Helm", "=ds=#sr# 215"};
	{ 8, "s86814", "62166", "=q3=Steel Plated Knuckles", "=ds=#sr# 185"};
	{ 9, "s86711", "62091", "=q3=Attuned Steel Shoulders", "=ds=#sr# 185"};
	{10, "s3508", "3844", "=q3=Green Iron Hauberk", "=ds=#sr# 180"};
	{11, "s2675", "2870", "=q3=Shining Silver Breastplate", "=ds=#sr# 145"};
	{12, "s86809", "62161", "=q3=Iridescent Knuckles", "=ds=#sr# 140"};
	{13, "s86709", "62089", "=q3=Attuned Bronze Breastplate", "=ds=#sr# 130"};
	{14, "s16663", "12422", "=q2=Imperial Plate Chest", "=ds=#sr# 300"};
	{15, "s16730", "12429", "=q2=Imperial Plate Leggings", "=ds=#sr# 300"};
	{16, "s16725", "12420", "=q2=Radiant Leggings", "=ds=#sr# 300"};
	{17, "s16665", "12611", "=q2=Runic Plate Boots", "=ds=#sr# 300"};
	{18, "s16732", "12614", "=q2=Runic Plate Leggings", "=ds=#sr# 300"};
	{19, "s16726", "12612", "=q2=Runic Plate Helm", "=ds=#sr# 300"};
	{20, "s16664", "12610", "=q2=Runic Plate Shoulders", "=ds=#sr# 300"};
	{21, "s16662", "12414", "=q2=Thorium Leggings", "=ds=#sr# 300"};
	{22, "s16657", "12426", "=q2=Imperial Plate Boots", "=ds=#sr# 295"};
	{23, "s16658", "12427", "=q2=Imperial Plate Helm", "=ds=#sr# 295"};
	{24, "s16659", "12417", "=q2=Radiant Circlet", "=ds=#sr# 295"};
	{25, "s16656", "12419", "=q2=Radiant Boots", "=ds=#sr# 290"};
	{26, "s16654", "12418", "=q2=Radiant Gloves", "=ds=#sr# 285"};
	{27, "s16652", "12409", "=q2=Thorium Boots", "=ds=#sr# 280"};
	{28, "s16653", "12410", "=q2=Thorium Helm", "=ds=#sr# 280"};
	{29, "s15295", "11605", "=q2=Dark Iron Shoulders", "=ds=#sr# 280"};
	{30, "s15293", "11606", "=q2=Dark Iron Mail", "=ds=#sr# 270"};
...
AtlasLoot_Data["SmithingArmorOld3"] = {
	{ 1, "s16649", "12425", "=q2=Imperial Plate Bracers", "=ds=#sr# 270"};
	{ 2, "s16648", "12415", "=q2=Radiant Breastplate", "=ds=#sr# 270"};
	{ 3, "s16647", "12424", "=q2=Imperial Plate Belt", "=ds=#sr# 265"};
	{ 4, "s16646", "12428", "=q2=Imperial Plate Shoulders", "=ds=#sr# 265"};
	{ 5, "s9979", "7936", "=q2=Ornate Mithril Boots", "=ds="..AL["Quest"]..""};
	{ 6, "s9972", "7935", "=q2=Ornate Mithril Breastplate", "=ds="..AL["Quest"]..""};
	{ 7, "s9980", "7937", "=q2=Ornate Mithril Helm", "=ds="..AL["Quest"]..""};
	{ 8, "s16645", "12416", "=q2=Radiant Belt", "=ds=#sr# 260"};
	{ 9, "s16644", "12408", "=q2=Thorium Bracers", "=ds=#sr# 255"};
	{10, "s16642", "12405", "=q2=Thorium Armor", "=ds=#sr# 250"};
	{11, "s16643", "12406", "=q2=Thorium Belt", "=ds=#sr# 250"};
	{12, "s9970", "7934", "=q2=Heavy Mithril Helm", "=ds=#sr# 245"};
	{13, "s9966", "7932", "=q2=Mithril Scale Shoulders", "=ds=#sr# 235"};
	{14, "s9968", "7933", "=q2=Heavy Mithril Boots", "=ds=#sr# 235"};
	{15, "s9959", "7930", "=q2=Heavy Mithril Breastplate", "=ds=#sr# 230"};
	{16, "s9961", "7931", "=q2=Mithril Coif", "=ds=#sr# 230"};
	{17, "s9952", "7928", "=q2=Ornate Mithril Shoulder", "=ds=#sr# 225"};
	{18, "s9950", "7927", "=q2=Ornate Mithril Gloves", "=ds=#sr# 220"};
	{19, "s9945", "7926", "=q2=Ornate Mithril Pants", "=ds=#sr# 220"};
	{20, "s9937", "7924", "=q2=Mithril Scale Bracers", "=ds=#sr# 215"};
	{21, "s9931", "7920", "=q2=Mithril Scale Pants", "=ds=#sr# 210"};
	{22, "s9933", "7921", "=q2=Heavy Mithril Pants", "=ds=#sr# 210"};
	{23, "s9957", "7929", "=q2=Orcish War Leggings", "=ds="..AL["Quest"]..""};
	{24, "s9928", "7919", "=q2=Heavy Mithril Gauntlet", "=ds=#sr# 205"};
	{25, "s9926", "7918", "=q2=Heavy Mithril Shoulder", "=ds=#sr# 205"};
	{26, "s11643", "9366", "=q2=Golden Scale Gauntlets", "=ds=#sr# 205"};
	{27, "s9916", "7963", "=q2=Steel Breastplate", "=ds=#sr# 200"};
	{28, "s3515", "3847", "=q2=Golden Scale Boots", "=ds=#sr# 200"};
	{29, "s3511", "3845", "=q2=Golden Scale Cuirass", "=ds=#sr# 195"};
	{30, "s3503", "3837", "=q2=Golden Scale Coif", "=ds=#sr# 190"};
...
AtlasLoot_Data["SmithingArmorOld4"] = {
	{ 1, "s3513", "3846", "=q2=Polished Steel Boots", "=ds=#sr# 185"};
	{ 2, "s9820", "7917", "=q2=Barbaric Iron Gloves", "=ds=#sr# 185"};
	{ 3, "s9818", "7916", "=q2=Barbaric Iron Boots", "=ds=#sr# 180"};
	{ 4, "s9814", "7915", "=q2=Barbaric Iron Helm", "=ds=#sr# 175"};
	{ 5, "s3505", "3841", "=q2=Golden Scale Shoulders", "=ds=#sr# 175"};
	{ 6, "s3507", "3843", "=q2=Golden Scale Leggings", "=ds=#sr# 170"};
	{ 7, "s3502", "3836", "=q2=Green Iron Helm", "=ds=#sr# 170"};
	{ 8, "s9813", "7914", "=q2=Barbaric Iron Breastplate", "=ds=#sr# 160"};
	{ 9, "s9811", "7913", "=q2=Barbaric Iron Shoulders", "=ds=#sr# 160"};
	{10, "s3504", "3840", "=q2=Green Iron Shoulders", "=ds=#sr# 160"};
	{11, "s3506", "3842", "=q2=Green Iron Leggings", "=ds=#sr# 155"};
	{12, "s12259", "10423", "=q2=Silvered Bronze Leggings", "=ds=#sr# 155"};
	{13, "s3336", "3485", "=q2=Green Iron Gauntlets", "=ds=#sr# 150"};
	{14, "s3334", "3484", "=q2=Green Iron Boots", "=ds=#sr# 145"};
	{15, "s3333", "3483", "=q2=Silvered Bronze Gauntlets", "=ds=#sr# 135"};
	{16, "s3331", "3482", "=q2=Silvered Bronze Boots", "=ds=#sr# 130"};
	{17, "s2673", "2869", "=q2=Silvered Bronze Breastplate", "=ds=#sr# 130"};
	{18, "s3330", "3481", "=q2=Silvered Bronze Shoulders", "=ds=#sr# 125"};
	{19, "s2672", "2868", "=q2=Patterned Bronze Bracers", "=ds=#sr# 120"};
	{20, "s87542", "64911", "=q2=Rough Bronze Gloves", "=ds=#sr# 115"};
	{21, "s2668", "2865", "=q2=Rough Bronze Leggings", "=ds=#sr# 105"};
	{22, "s8367", "6731", "=q2=Ironforge Breastplate", "=ds=#sr# 100"};
	{23, "s2667", "2864", "=q2=Runed Copper Breastplate", "=ds=#sr# 80"};
	{24, "s86805", "62158", "=q2=Copper Plated Knuckles", "=ds=#sr# 70"};
	{25, "s86710", "62090", "=q2=Attuned Copper Leggings", "=ds=#sr# 65"};
	{26, "s3325", "3474", "=q2=Gemmed Copper Gauntlets", "=ds=#sr# 60"};
	{27, "s3324", "3473", "=q2=Runed Copper Pants", "=ds=#sr# 45"};
	{28, "s3321", "3471", "=q2=Copper Chain Vest", "=ds=#sr# 35"};
	{29, "s3501", "3835", "=q2=Green Iron Bracers", "=ds=#sr# 165"};
	{30, "s2670", "2866", "=q2=Rough Bronze Cuirass", "=ds=#sr# 105"};
...
AtlasLoot_Data["SmithingArmorOld5"] = {
	{ 1, "s7817", "6350", "=q2=Rough Bronze Boots", "=ds=#sr# 95"};
	{ 2, "s2664", "2854", "=q2=Runed Copper Bracers", "=ds=#sr# 90"};
	{ 3, "s3323", "3472", "=q2=Runed Copper Gauntlets", "=ds=#sr# 40"};
	{ 4, "s7223", "6040", "=q1=Golden Scale Bracers", "=ds=#sr# 185"};
	{ 5, "s3328", "3480", "=q1=Rough Bronze Shoulders", "=ds=#sr# 110"};
	{ 6, "s2666", "2857", "=q1=Runed Copper Belt", "=ds=#sr# 70"};
	{ 7, "s2661", "2851", "=q1=Copper Chain Belt", "=ds=#sr# 35"};
	{ 8, "s3319", "3469", "=q1=Copper Chain Boots", "=ds=#sr# 20"};
	{ 9, "s2663", "2853", "=q1=Copper Bracers", "=ds=#sr# 1"};
	{10, "s2662", "2852", "=q1=Copper Chain Pants", "=ds=#sr# 1"};
	{11, "s12260", "10421", "=q1=Rough Copper Vest", "=ds=#sr# 1"};
...
AtlasLoot_Data["Cooking1"] = {
	{ 1, "s90083", "90075", "=q1=Honey Butter Bread", "=ds=#sr# 300"};
	{ 2, "s85404", "61733", "=q1=Coal-Roasted Potatoes", "=ds=#sr# 300"};
	{ 3, "s87886", "64921", "=q1=Dark Iron Fish and Chips", "=ds=#sr# 300"};
	{ 4, "s87293", "62994", "=q1=Deviate Feast", "=ds=#sr# 300"};
	{ 5, "s85405", "61735", "=q1=Malistar's Revenge", "=ds=#sr# 300"};
	{ 6, "s85796", "61908", "=q1=Molten Skullfish", "=ds=#sr# 300"};
	{ 7, "s87901", "64935", "=q1=Stratholme Saperavi", "=ds=#sr# 300"};
	{ 8, "s85126", "60630", "=q1=Lobster Roll", "=ds=#sr# 285"};
	{ 9, "s85233", "60761", "=q1=Felstone Grog", "=ds=#sr# 280"};
	{10, "s18247", "13935", "=q1=Baked Salmon", "=ds=#sr# 275"};
	{11, "s18245", "13933", "=q1=Lobster Stew", "=ds=#sr# 275"};
	{12, "s18246", "13934", "=q1=Mightfish Steak", "=ds=#sr# 275"};
	{13, "s86763", "62133", "=q1=Protein Shake", "=ds=#sr# 265"};
	{14, "s87900", "64933", "=q1=Sauteed Plated Armorfish", "=ds=#sr# 265"};
	{15, "s85251", "60772", "=q1=Suspicious Stew", "=ds=#sr# 250"};
	{16, "s46684", "35563", "=q1=Charred Bear Kabobs", "=ds=#sr# 250"};
	{17, "s46688", "35565", "=q1=Juicy Bear Burger", "=ds=#sr# 250"};
	{18, "s18243", "13931", "=q1=Nightfin Soup", "=ds=#sr# 250"};
	{19, "s18244", "13932", "=q1=Poached Sunscale Salmon", "=ds=#sr# 250"};
	{20, "s18240", "13928", "=q1=Grilled Squid", "=ds=#sr# 240"};
	{21, "s18242", "13929", "=q1=Hot Smoked Bass", "=ds=#sr# 240"};
	{22, "s86215", "61982", "=q1=Bone Meal", "=ds=#sr# 230"};
	{23, "s85123", "60628", "=q1=Crestfall Crab Taco", "=ds=#sr# 225"};
	{24, "s64054", "33004", "=q1=Clamlette Magnifique", "=ds=#sr# 225"};
	{25, "s18239", "13927", "=q1=Cooked Glossy Mightfish", "=ds=#sr# 225"};
	{26, "s18241", "13930", "=q1=Filet of Redgill", "=ds=#sr# 225"};
	{27, "s15933", "12218", "=q1=Monster Omelet", "=ds=#sr# 225"};
	{28, "s15915", "12216", "=q1=Spiced Chili Crab", "=ds=#sr# 225"};
	{29, "s18238", "6887", "=q1=Spotted Yellowtail", "=ds=#sr# 225"};
	{30, "s22480", "18045", "=q1=Tender Wolf Steak", "=ds=#sr# 225"};
...
AtlasLoot_Data["Cooking2"] = {
	{ 1, "s20626", "16766", "=q1=Undermine Clam Chowder", "=ds=#sr# 225"};
	{ 2, "s15906", "12217", "=q1=Dragonbreath Chili", "=ds=#sr# 200"};
	{ 3, "s15910", "12215", "=q1=Heavy Kodo Stew", "=ds=#sr# 200"};
	{ 4, "s21175", "17222", "=q1=Spider Sausage", "=ds=#sr# 200"};
	{ 5, "s4094", "4457", "=q1=Barbecued Buzzard Wing", "=ds=#sr# 175"};
	{ 6, "s15863", "12213", "=q1=Carrion Surprise", "=ds=#sr# 175"};
	{ 7, "s7213", "6038", "=q1=Giant Clam Scorcho", "=ds=#sr# 175"};
	{ 8, "s15856", "13851", "=q1=Hot Wolf Ribs", "=ds=#sr# 175"};
	{ 9, "s15861", "12212", "=q1=Jungle Stew", "=ds=#sr# 175"};
	{10, "s20916", "8364", "=q1=Mithril Head Trout", "=ds=#sr# 175"};
	{11, "s15865", "12214", "=q1=Mystery Stew", "=ds=#sr# 175"};
	{12, "s15855", "12210", "=q1=Roast Raptor", "=ds=#sr# 175"};
	{13, "s7828", "4594", "=q1=Rockscale Cod", "=ds=#sr# 175"};
	{14, "s13028", "10841", "=q1=Goldthorn Tea", "=ds=#sr# 175"};
	{15, "s25954", "21217", "=q1=Sagefish Delight", "=ds=#sr# 175"};
	{16, "s3400", "3729", "=q1=Soothing Turtle Bisque", "=ds=#sr# 175"};
	{17, "s85127", "60633", "=q1=Seafarer's Swig", "=ds=#sr# 175"};
	{18, "s84246", "60036", "=q1=Springsocket Eel", "=ds=#sr# 175"};
	{19, "s24418", "20074", "=q1=Heavy Crocolisk Stew", "=ds=#sr# 150"};
	{20, "s3399", "3728", "=q1=Tasty Lion Steak", "=ds=#sr# 150"};
	{21, "s85119", "60626", "=q1=Black Coffee", "=ds=#sr# 145"};
	{22, "s3376", "3665", "=q1=Curiously Tasty Omelet", "=ds=#sr# 130"};
	{23, "s6500", "5527", "=q1=Goblin Deviled Clams", "=ds=#sr# 125"};
	{24, "s3398", "3727", "=q1=Hot Lion Chops", "=ds=#sr# 125"};
	{25, "s15853", "12209", "=q1=Lean Wolf Steak", "=ds=#sr# 125"};
	{26, "s3373", "3664", "=q1=Crocolisk Gumbo", "=ds=#sr# 120"};
	{27, "s3397", "3726", "=q1=Big Bear Steak", "=ds=#sr# 110"};
	{28, "s3377", "3666", "=q1=Gooey Spider Cake", "=ds=#sr# 110"};
	{29, "s6419", "5480", "=q1=Lean Venison", "=ds=#sr# 110"};
	{30, "s2548", "2685", "=q1=Succulent Pork Ribs", "=ds=#sr# 110"};
	Prev = "Cooking1";
	Next = "Cooking3";
	Back = "CRAFTINGMENU";
};
...
AtlasLoot_Data["Cooking3"] = {
	{ 1, "s7755", "4593", "=q1=Bristle Whisker Catfish", "=ds=#sr# 100"};
	{ 2, "s6418", "5479", "=q1=Crispy Lizard Tail", "=ds=#sr# 100"};
	{ 3, "s2547", "1082", "=q1=Redridge Goulash", "=ds=#sr# 100"};
	{ 4, "s2549", "1017", "=q1=Seasoned Wolf Kabob", "=ds=#sr# 100"};
	{ 5, "s45695", "34832", "=q1=Captain Rumsey's Lager", "=ds=#sr# 100"};
	{ 6, "s6501", "5526", "=q1=Clam Chowder", "=ds=#sr# 90"};
	{ 7, "s6417", "5478", "=q1=Dig Rat Stew", "=ds=#sr# 90"};
	{ 8, "s3372", "3663", "=q1=Murloc Fin Soup", "=ds=#sr# 90"};
	{ 9, "s2545", "2682", "=q1=Cooked Crab Claw", "=ds=#sr# 85"};
	{10, "s8238", "6657", "=q1=Savory Deviate Delight", "=ds=#sr# 85"};
	{11, "s3370", "3662", "=q1=Crocolisk Steak", "=ds=#sr# 80"};
	{12, "s2546", "2687", "=q1=Dry Pork Ribs", "=ds=#sr# 80"};
	{13, "s25704", "21072", "=q1=Smoked Sagefish", "=ds=#sr# 80"};
	{14, "s2544", "2683", "=q1=Crab Cake", "=ds=#sr# 75"};
	{15, "s2543", "733", "=q1=Westfall Stew", "=ds=#sr# 50"};
	{16, "s3371", "3220", "=q1=Blood Sausage", "=ds=#sr# 60"};
	{17, "s9513", "7676", "=q1=Thistle Tea", "=ds=#sr# 60"};
	{18, "s6499", "5525", "=q1=Boiled Clams", "=ds=#sr# 50"};
	{19, "s2541", "2684", "=q1=Coyote Steak", "=ds=#sr# 50"};
	{20, "s6415", "5476", "=q1=Fillet of Frenzy", "=ds=#sr# 50"};
	{21, "s2542", "724", "=q1=Goretusk Liver Pie", "=ds=#sr# 50"};
	{22, "s7754", "6316", "=q1=Loch Frenzy Delight", "=ds=#sr# 50"};
	{23, "s7753", "4592", "=q1=Longjaw Mud Snapper", "=ds=#sr# 50"};
	{24, "s7827", "5095", "=q1=Rainbow Fin Albacore", "=ds=#sr# 50"};
	{25, "s6416", "5477", "=q1=Strider Stew", "=ds=#sr# 50"};
	{26, "s8607", "6890", "=q1=Smoked Bear Meat", "=ds=#sr# 40"};
	{27, "s6414", "5474", "=q1=Roasted Kodo Meat", "=ds=#sr# 35"};
	{28, "s85212", "60712", "=q1=Dolanaar Tea", "=ds=#sr# 20"};
	{29, "s6413", "5473", "=q1=Scorpid Surprise", "=ds=#sr# 20"};
	{30, "s2795", "2888", "=q1=Beer Basted Boar Ribs", "=ds=#sr# 10"};
	Next = "Cooking4";
	Prev = "Cooking2";
	Back = "CRAFTINGMENU";
};
...
AtlasLoot_Data["Cooking4"] = {
	{ 1, "s6412", "5472", "=q1=Kaldorei Spider Kabob", "=ds=#sr# 10"};
	{ 2, "s2539", "2680", "=q1=Spiced Wolf Meat", "=ds=#sr# 1"};
	{ 3, "s7751", "6290", "=q1=Brilliant Smallfish", "=ds=#sr# 1"};
	{ 4, "s2538", "2679", "=q1=Charred Wolf Meat", "=ds=#sr# 1"};
	{ 5, "s15935", "12224", "=q1=Crispy Bat Wing", "=ds=#sr# 1"};
	{ 6, "s8604", "6888", "=q1=Herb Baked Egg", "=ds=#sr# 1"};
	{ 7, "s2540", "2681", "=q1=Roasted Boar Meat", "=ds=#sr# 1"};
	{ 8, "s7752", "787", "=q1=Slitherskin Mackerel", "=ds=#sr# 1"};
...
AtlasLoot_Data["EnchantingMisc1"] = {
	{ 1, "s150176", "90541", "=q1=Magical Components,", "=ds=#sr# 300"};

	{ 3, "s150185", "90960", "=q4=Lesson of the Doom Lord,", "=ds=#sr# 300"};

	{ 4, "s86784", "62139", "=q4=Orb of Calamity", "=ds=#sr# 215"};
	{ 5, "s15596", "11811", "=q3=Smoking Heart of the Mountain", "=ds=#sr# 265"};
	{ 6, "s86785", "62140", "=q3=Spellweaver", "=ds=#sr# 300"};
	{ 7, "s86791", "62145", "=q3=Stanchion of Dazzling Light", "=ds=#sr# 300"};
	{ 8, "s86789", "62143", "=q3=Staff of the Moon", "=ds=#sr# 295"};
	{ 9, "s84408", "60183", "=q3=Staff of the Cursed Seer", "=ds=#sr# 250"};
	...
	{23, "s86786", "62142", "=q3=Staff of Affinity", "=ds=#sr# 140"};
	{24, "s25126", "20746", "=q1=Lesser Wizard Oil", "=ds=#sr# 200"};
	{25, "s25125", "20745", "=q1=Minor Mana Oil", "=ds=#sr# 150"};

	{27, "s25124", "20744", "=q1=Minor Wizard Oil", "=ds=#sr# 45"};
	{28, "s85246", "60768", "=q3=Felstone", "=ds=#sr# 300"};
	{29, "s85256", "60787", "=q1=Scroll of Recall: Teles'aran", "=ds=#sr# 250"};
...
AtlasLoot_Data["EnchantingMisc2"] = {
	...
	{16, "s86386", "11084", "=q3=Propagate: Small Glimmering Shard", "=ds=#sr# 125"};
	{17, "s86387", "11139", "=q3=Propagate: Small Glowing Shard", "=ds=#sr# 185"};
	{18, "s86388", "11178", "=q3=Propagate: Small Radiant Shard", "=ds=#sr# 230"};
	{19, "s86389", "14344", "=q3=Propagate: Small Brilliant Shard", "=ds=#sr# 270"};
...
AtlasLoot_Data["LeatherLeatherArmorOld1"] = {
	{ 1, "s150183", "90962", "=q4=Barkskin Trousers,", "=ds=#sr# 300"};
	{ 2, "s87909", "64946", "=q4=Flamewarders", "=ds=#sr# 300"};
	{ 3, "s84396", "60166", "=q4=Lava Boots", "=ds=#sr# 300"};
	{ 4, "s84397", "60168", "=q4=Lava Bracers", "=ds=#sr# 300"};
	{ 5, "s84402", "60176", "=q4=Lava Chestguard", "=ds=#sr# 300"};
	{ 6, "s84398", "60170", "=q4=Lava Gauntlets", "=ds=#sr# 300"};
	{ 7, "s84400", "60172", "=q4=Lava Helm", "=ds=#sr# 300"};
	{ 8, "s84401", "60174", "=q4=Lava Leggings", "=ds=#sr# 300"};
	{ 9, "s87907", "64944", "=q4=Devil's Feet", "=ds=#sr# 300"};
	{10, "s23709", "19162", "=q4=Corehound Belt", "=ds=#sr# 300"};
	{11, "s23707", "19149", "=q4=Lava Belt", "=ds=#sr# 300"};
	{12, "s23710", "19163", "=q4=Molten Belt", "=ds=#sr# 300"};
	{13, "s20854", "16983", "=q4=Molten Helm", "=ds=#sr# 300"};
	{14, "s20853", "16982", "=q4=Corehound Boots", "=ds=#sr# 295"};
	{15, "s87993", "65718", "=q3=Lizard King's Hide", "=ds=#sr# 300"};
	{16, "s19097", "15062", "=q3=Devilsaur Leggings", "=ds=#sr# 300"};
	{17, "s23706", "19058", "=q3=Golden Mantle of the Dawn", "=ds=#sr# 300"};
	{18, "s19095", "15059", "=q3=Living Breastplate", "=ds=#sr# 300"};
	{19, "s26279", "21278", "=q3=Stormshroud Gloves", "=ds=#sr# 300"};
	{20, "s23704", "19049", "=q3=Timbermaw Brawlers", "=ds=#sr# 300"};
	{21, "s22922", "18506", "=q3=Mongoose Boots", "=ds=#sr# 300"};
	{22, "s22921", "18504", "=q3=Girdle of Insight", "=ds=#sr# 300"};
	{23, "s19090", "15058", "=q3=Stormshroud Shoulders", "=ds=#sr# 295"};
	{24, "s23705", "19052", "=q3=Dawn Treaders", "=ds=#sr# 290"};
	{25, "s19084", "15063", "=q3=Devilsaur Gauntlets", "=ds=#sr# 290"};
	{26, "s19086", "15066", "=q3=Ironfeather Breastplate", "=ds=#sr# 290"};
	{27, "s23703", "19044", "=q3=Might of the Timbermaw", "=ds=#sr# 290"};
	{28, "s86846", "62188", "=q3=Living Helm", "=ds=#sr# 285"};
	{29, "s19078", "15060", "=q3=Living Leggings", "=ds=#sr# 285"};
	{30, "s19079", "15056", "=q3=Stormshroud Armor", "=ds=#sr# 285"};
	Next = "LeatherLeatherArmorOld2";
	Back = "LEATHERWORKINGMENU";
};

AtlasLoot_Data["LeatherLeatherArmorOld2"] = {
	{ 1, "s19080", "15065", "=q3=Warbear Woolies", "=ds=#sr# 285"};
	{ 2, "s19067", "15057", "=q3=Stormshroud Pants", "=ds=#sr# 275"};
	{ 3, "s19068", "15064", "=q3=Warbear Harness", "=ds=#sr# 275"};
	{ 4, "s19062", "15067", "=q3=Ironfeather Shoulders", "=ds=#sr# 270"};
	{ 5, "s19061", "15061", "=q3=Living Shoulders", "=ds=#sr# 270"};
	{ 6, "s36074", "29964", "=q3=Blackstorm Leggings", "=ds=#sr# 260"};
	{ 7, "s36075", "29970", "=q3=Wildfeather Leggings", "=ds=#sr# 260"};
	{ 8, "s10647", "8349", "=q3=Feathered Breastplate", "=ds=#sr# 250"};
	{ 9, "s10632", "8348", "=q3=Helm of Fire", "=ds=#sr# 250"};
	{10, "s84410", "60187", "=q3=Searing Mitts", "=ds=#sr# 250"};
	{11, "s10630", "8346", "=q3=Gauntlets of the Sea", "=ds=#sr# 230"};
	{12, "s10621", "8345", "=q3=Wolfshead Helm", "=ds=#sr# 225"};
	{13, "s86872", "62204", "=q3=Thick Enchanted Boots", "=ds=#sr# 220"};
	{14, "s22711", "18238", "=q3=Shadowskin Gloves", "=ds=#sr# 200"};
	{15, "s3778", "4262", "=q3=Gem-studded Leather Belt", "=ds=#sr# 185"};
	{16, "s86834", "62178", "=q3=Heavy Attuned Armor", "=ds=#sr# 185"};
	{17, "s86854", "62193", "=q3=Pearl Encrusted Shoulders", "=ds=#sr# 160"};
	{18, "s23399", "18948", "=q3=Barbaric Bracers", "=ds=#sr# 155"};
	{19, "s3770", "4253", "=q3=Toughened Leather Gloves", "=ds=#sr# 135"};
	{20, "s2166", "2314", "=q3=Toughened Leather Armor", "=ds=#sr# 120"};
	{21, "s7955", "6468", "=q3=Deviate Scale Belt", "=ds=#sr# 115"};
	{22, "s86824", "62172", "=q3=Bracers of Affinity", "=ds=#sr# 115"};
	{23, "s86873", "62205", "=q3=Toughened Leather Pants", "=ds=#sr# 100"};
...
AtlasLoot_Data["LeatherLeatherArmorOld3"] = {
	{ 1, "s19087", "15070", "=q2=Frostsaber Gloves", "=ds=#sr# 295"};
	{ 2, "s19081", "15075", "=q2=Chimeric Vest", "=ds=#sr# 290"};
	{ 3, "s19082", "15094", "=q2=Runic Leather Headband", "=ds=#sr# 290"};
	{ 4, "s19083", "15087", "=q2=Wicked Leather Pants", "=ds=#sr# 290"};
	{ 5, "s86383", "62005", "=q2=Wicked Leather Spaulders", "=ds=#sr# 290"};
	{ 6, "s19074", "15069", "=q2=Frostsaber Leggings", "=ds=#sr# 285"};
	{ 7, "s19076", "15053", "=q2=Volcanic Breastplate", "=ds=#sr# 285"};
	{ 8, "s19073", "15072", "=q2=Chimeric Leggings", "=ds=#sr# 280"};
	{ 9, "s19072", "15093", "=q2=Runic Leather Belt", "=ds=#sr# 280"};
	{10, "s19071", "15086", "=q2=Wicked Leather Headband", "=ds=#sr# 280"};
	{11, "s19065", "15092", "=q2=Runic Leather Bracers", "=ds=#sr# 275"};
	{12, "s19063", "15073", "=q2=Chimeric Boots", "=ds=#sr# 275"};
	{13, "s19066", "15071", "=q2=Frostsaber Boots", "=ds=#sr# 275"};
	{14, "s19055", "15091", "=q2=Runic Leather Gauntlets", "=ds=#sr# 270"};
	{15, "s19059", "15054", "=q2=Volcanic Leggings", "=ds=#sr# 270"};
	{16, "s87277", "62206", "=q2=Wicked Leather Boots", "=ds=#sr# 270"};
	{17, "s19053", "15074", "=q2=Chimeric Gloves", "=ds=#sr# 265"};
	{18, "s19052", "15084", "=q2=Wicked Leather Bracers", "=ds=#sr# 265"};
	{19, "s19049", "15083", "=q2=Wicked Leather Gauntlets", "=ds=#sr# 260"};
	{20, "s10572", "8212", "=q2=Wild Leather Leggings", "=ds=#sr# 250"};
	{21, "s10566", "8213", "=q2=Wild Leather Boots", "=ds=#sr# 245"};
	{22, "s10560", "8202", "=q2=Big Voodoo Pants", "=ds=#sr# 240"};
	{23, "s10558", "8197", "=q2=Nightscape Boots", "=ds=#sr# 235"};
	{24, "s10548", "8193", "=q2=Nightscape Pants", "=ds=#sr# 230"};
	{25, "s10546", "8214", "=q2=Wild Leather Helmet", "=ds=#sr# 225"};
	{26, "s10544", "8211", "=q2=Wild Leather Vest", "=ds=#sr# 225"};
	{27, "s10531", "8201", "=q2=Big Voodoo Mask", "=ds=#sr# 220"};
	{28, "s10529", "8210", "=q2=Wild Leather Shoulders", "=ds=#sr# 220"};
	{29, "s10520", "8200", "=q2=Big Voodoo Robe", "=ds=#sr# 215"};
	{30, "s10516", "8192", "=q2=Nightscape Shoulders", "=ds=#sr# 210"};
...
AtlasLoot_Data["LeatherLeatherArmorOld4"] = {
	{ 1, "s10507", "8176", "=q2=Nightscape Headband", "=ds=#sr# 205"};
	{ 2, "s10499", "8175", "=q2=Nightscape Tunic", "=ds=#sr# 205"};
	{ 3, "s3779", "4264", "=q2=Barbaric Belt", "=ds=#sr# 200"};
	{ 4, "s10490", "8174", "=q2=Comfortable Leather Hat", "=ds=#sr# 200"};
	{ 5, "s9207", "7390", "=q2=Dusky Boots", "=ds=#sr# 200"};
	{ 6, "s9208", "7391", "=q2=Swift Boots", "=ds=#sr# 200"};
	{ 7, "s9206", "7387", "=q2=Dusky Belt", "=ds=#sr# 195"};
	{ 8, "s3777", "4260", "=q2=Guardian Leather Bracers", "=ds=#sr# 195"};
	{ 9, "s21943", "17721", "=q2=Gloves of the Greatfather", "=ds=#sr# 190"};
	{10, "s9202", "7386", "=q2=Green Whelp Bracers", "=ds=#sr# 190"};
	{11, "s6705", "5783", "=q2=Murloc Scale Bracers", "=ds=#sr# 190"};
	{12, "s9201", "7378", "=q2=Dusky Bracers", "=ds=#sr# 185"};
	{13, "s3776", "4259", "=q2=Green Leather Bracers", "=ds=#sr# 180"};
	{14, "s7151", "5964", "=q2=Barbaric Shoulders", "=ds=#sr# 175"};
	{15, "s9196", "7374", "=q2=Dusky Leather Armor", "=ds=#sr# 175"};
	{16, "s9197", "7375", "=q2=Green Whelp Armor", "=ds=#sr# 175"};
	{17, "s3773", "4256", "=q2=Guardian Armor", "=ds=#sr# 175"};
	{18, "s86836", "62180", "=q2=Heavy Wrapped Belt", "=ds=#sr# 175"};
	{19, "s7149", "5963", "=q2=Barbaric Leggings", "=ds=#sr# 170"};
	{20, "s3775", "4258", "=q2=Guardian Belt", "=ds=#sr# 170"};
	{21, "s6704", "5782", "=q2=Thick Murloc Armor", "=ds=#sr# 170"};
	{22, "s86853", "62192", "=q2=Murloc Scale Gloves", "=ds=#sr# 170"};
	{23, "s9195", "7373", "=q2=Dusky Leather Leggings", "=ds=#sr# 165"};
	{24, "s4097", "4456", "=q2=Raptor Hide Belt", "=ds=#sr# 165"};
	{25, "s4096", "4455", "=q2=Raptor Hide Harness", "=ds=#sr# 165"};
	{26, "s3774", "4257", "=q2=Green Leather Belt", "=ds=#sr# 160"};
	{27, "s7147", "5962", "=q2=Guardian Pants", "=ds=#sr# 160"};
	{28, "s3772", "4255", "=q2=Green Leather Armor", "=ds=#sr# 155"};
	{29, "s3771", "4254", "=q2=Barbaric Gloves", "=ds=#sr# 150"};
	{30, "s9149", "7359", "=q2=Heavy Earthen Gloves", "=ds=#sr# 145"};
...
AtlasLoot_Data["LeatherLeatherArmorOld5"] = {
	{ 1, "s3764", "4247", "=q2=Hillman's Leather Gloves", "=ds=#sr# 145"};
	{ 2, "s3769", "4252", "=q2=Dark Leather Shoulders", "=ds=#sr# 140"};
	{ 3, "s9148", "7358", "=q2=Pilferer's Gloves", "=ds=#sr# 140"};
	{ 4, "s86825", "62173", "=q2=Brown Leather Tunic", "=ds=#sr# 140"};
	...
	{ 8, "s86835", "62179", "=q2=Toughened Leather Hat", "=ds=#sr# 130"};
	{ 9, "s3766", "4249", "=q2=Dark Leather Belt", "=ds=#sr# 125"};
	{10, "s9145", "7348", "=q2=Fletcher's Gloves", "=ds=#sr# 125"};
	{11, "s3767", "4250", "=q2=Hillman's Belt", "=ds=#sr# 120"};
	{12, "s9074", "7285", "=q2=Nimble Leather Gloves", "=ds=#sr# 120"};
	{13, "s9072", "7284", "=q2=Red Whelp Gloves", "=ds=#sr# 120"};
	{14, "s3765", "4248", "=q2=Dark Leather Gloves", "=ds=#sr# 120"};
	{15, "s7135", "5961", "=q2=Dark Leather Pants", "=ds=#sr# 115"};
	{16, "s7954", "6467", "=q2=Deviate Scale Gloves", "=ds=#sr# 105"};
	{17, "s7133", "5958", "=q2=Fine Leather Pants", "=ds=#sr# 105"};
	{18, "s24940", "20575", "=q2=Black Whelp Tunic", "=ds=#sr# 100"};
	{19, "s2169", "2317", "=q2=Dark Leather Tunic", "=ds=#sr# 100"};
	{20, "s3762", "4244", "=q2=Hillman's Leather Vest", "=ds=#sr# 100"};
	{21, "s9068", "7282", "=q2=Light Leather Pants", "=ds=#sr# 95"};
	{22, "s6703", "5781", "=q2=Murloc Scale Breastplate", "=ds=#sr# 95"};
	{23, "s8322", "6709", "=q2=Moonglow Vest", "=ds=#sr# 90"};
	{24, "s6702", "5780", "=q2=Murloc Scale Belt", "=ds=#sr# 90"};
	{25, "s3761", "4243", "=q2=Fine Leather Tunic", "=ds=#sr# 85"};
	{26, "s3759", "4242", "=q2=Embossed Leather Pants", "=ds=#sr# 75"};
	{27, "s2164", "2312", "=q2=Fine Leather Gloves", "=ds=#sr# 75"};
	{28, "s2161", "2309", "=q2=Embossed Leather Boots", "=ds=#sr# 55"};
	{29, "s2160", "2300", "=q2=Embossed Leather Vest", "=ds=#sr# 40"};
	{30, "s9064", "7280", "=q2=Rugged Leather Pants", "=ds=#sr# 35"};
...
AtlasLoot_Data["LeatherLeatherArmorOld6"] = {
	{ 1, "s7156", "5966", "=q2=Guardian Gloves", "=ds=#sr# 190"};
	{ 2, "s2167", "2315", "=q2=Dark Leather Boots", "=ds=#sr# 100"};
	{ 3, "s9065", "7281", "=q2=Light Leather Bracers", "=ds=#sr# 70"};
	{ 4, "s2163", "2311", "=q2=White Leather Jerkin", "=ds=#sr# 60"};
	{ 5, "s6661", "5739", "=q1=Barbaric Harness", "=ds=#sr# 190"};
	{ 6, "s2158", "2307", "=q1=Fine Leather Boots", "=ds=#sr# 90"};
	{ 7, "s3763", "4246", "=q1=Fine Leather Belt", "=ds=#sr# 80"};
	{ 8, "s86844", "62186", "=q1=Light Leather Shoulders", "=ds=#sr# 65"};
	{ 9, "s3756", "4239", "=q1=Embossed Leather Gloves", "=ds=#sr# 55"};
	{10, "s3753", "4237", "=q1=Handstitched Leather Belt", "=ds=#sr# 25"};
	{11, "s2153", "2303", "=q1=Handstitched Leather Pants", "=ds=#sr# 15"};
	{12, "s2149", "2302", "=q1=Handstitched Leather Boots", "=ds=#sr# 1"};
	{13, "s9059", "7277", "=q1=Handstitched Leather Bracers", "=ds=#sr# 1"};
	{14, "s9058", "7276", "=q1=Handstitched Leather Cloak", "=ds=#sr# 1"};
	{15, "s7126", "5957", "=q1=Handstitched Leather Vest", "=ds=#sr# 1"};
	{16, 0, "INV_Box_01", "=q6="..AL["World Events"], ""};
